  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
      <div className="flex gap-4 sm:gap-6">
        ...
        `}>
          <div className="absolute md:static right-0 top-0 bottom-0 w-72 md:w-full bg-white md:rounded-xl shadow-sm border border-gray-100 p-4 sm:p-5 overflow-y-auto">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mb-2">
            <button
              ...
              className="md:hidden flex items-center gap-1.5 text-sm font-semibold border border-gray-300 rounded-lg px-3 py-1.5 hover:bg-gray-50 transition-colors flex-shrink-0"
            >
              <SlidersHorizontal size={15} /> Filtros
            </button>
            <h1 className="text-sm sm:text-lg font-bold text-gray-900 truncate flex-1">
              {searchQuery ? `"${searchQuery}"` : selectedCategory || 'Todos os Produtos'}
            </h1>
          ...
          <div className="flex items-center justify-end gap-2 mb-3">
            ...
            <div className="relative">
              <select
                ...
                className="border border-gray-300 rounded-lg px-3 py-1.5 text-xs sm:text-sm pr-7 appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white"
              >
                {sortOptions.map(opt => (
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-base font-semibold text-gray-900 mb-1">Nenhum produto encontrado</h3>
